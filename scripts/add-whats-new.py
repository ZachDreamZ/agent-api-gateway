...
whats_new_code = '''import { useState } from 'react';
...
with open('src/dashboard/src/components/WhatsNew.tsx', 'w', encoding='utf-8') as f:
    f.write(whats_new_code)

print('Created WhatsNew.tsx component')
