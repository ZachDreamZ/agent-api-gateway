const fs = require('fs');
let content = fs.readFileSync('src/dashboard/src/pages/Billing.tsx', 'utf8');

const bannerCode = \// ─── Best First Purchase Banner ───
...
content = content.replace('// ─── Usage Bar ───', bannerCode + '// ─── Usage Bar ───');
fs.writeFileSync('src/dashboard/src/pages/Billing.tsx', content);
