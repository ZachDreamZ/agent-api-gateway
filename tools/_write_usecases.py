...
# Create use-case pages for high-intent SEO
page = r'''import { Link, useParams } from 'react-router-dom';
...
'''
Path('src/dashboard/src/pages/UseCases.tsx').write_text(page, encoding='utf-8')
print('UseCases.tsx written')
