...
content = content.replace('import { Check, X, Star, ExternalLink, Zap } from', 'import { Check, X, Star, ExternalLink, Zap, BadgeCheck } from')
...
old_section_end = '''{current.stripe_customer_id && (
                <button
                  type=\button\
...
new_section_end = '''{current.stripe_customer_id && (
                <button
                  type=\button\
                  onClick={handlePortal}
                  className=\btn
